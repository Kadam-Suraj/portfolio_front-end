...
const Education = async () => {
    ...
    return (
        <div>
            <div>
                <h2 className='text-transparent bg-clip-text bg-gradient-to-r from-[#B16CEA] via-[#FF5E69] to-[#FFA84B] w-fit text-[3em] font-bold pb-14 my-auto'>Education</h2>
                <div>{data.map((item, idx) => {
                    return <div key={idx} className='flex flex-col gap-5 justify-center border-b py-5 border-gray-400'>
                        ...
                        <div className='flex justify-between items-center gap-8'>
                            <span className='font-light text-opacity-80 darK:text-white'>{item.degree}</span>
